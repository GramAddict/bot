...
from GramAddict.core.handle_sources import handle_followers, scrape_followers
...
from GramAddict.core.utils import get_value, init_on_things, sample_sources, append_to_file
...
class ScrapeBloggerFollowers_Following(Plugin):
    """Handles the functionality of scraping usernames of a bloggers followers/following"""
